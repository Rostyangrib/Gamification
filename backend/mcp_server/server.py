...
@mcp.tool()
def core_completion_get_activities_completion_status(courseid: int, userid: int) -> str:
...
@mcp.tool()
def gradereport_user_get_grade_items(courseid: int, userid: int = 0, groupid: int = 0) -> str:
...
@mcp.tool()
def gradereport_user_get_grades_table(courseid: int, userid: int = 0, groupid: int = 0) -> str:
